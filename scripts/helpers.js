  ...
  _.each(sidebar, function(menu, category) {
      ...
      if(category == 'docs'){
        if(path == 'docs/index.html'){
          result += '<li><a href="/conditional-tokens/' + show_lang+ 'docs/technical_documentation.html">' + title + '</a>';
        }else{
          result += '<li class="'+ checkIfActive(path, show_lang + category) +'"><a href="/conditional-tokens/' + show_lang+ 'docs/technical_documentation.html">' + title + '</a>';
        }
      }else{
        result += '<li class="'+ checkIfActive(path, show_lang + category) +'"><a href="/conditional-tokens/' + show_lang + category + '/">' + title + '</a>';
      }
      if(typeof menu == 'object'){
          ...
          _.each(menu, function(title, link) {
              if(menu[category] != title){
                ...
                href = '/conditional-tokens/' + show_lang + href;
                if(title.startsWith("..")){
                  href = title.replace("../","");
...
hexo.extend.helper.register('raw_link', function(path) {
  return 'https://github.com/gnosis/conditional-tokens/edit/master/source/' + path;
});
